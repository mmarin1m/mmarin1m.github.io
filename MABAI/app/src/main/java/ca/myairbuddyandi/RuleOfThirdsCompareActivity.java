...
import ca.myairbuddyandi.databinding.RuleofthirdsCompareActivityBinding;

/**
 * Created by Michel on 2020-12-01.
 * Holds all the logic for the RulesOfThirdsCompareActivity class
 */

public class RuleOfThirdsCompareActivity extends AppCompatActivity {

    // Static
    private static final String LOG_TAG = "RulesOfThirdsCompareActivity";
    ...
    private RuleofthirdsCompareActivityBinding mBinding = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.ruleofthirds_compare_activity);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_contact_us) {
            ...
            intent.putExtra(getString(R.string.app_help_topic), getString(R.string.act_compare_rule_of_thirds_dives));
            startActivity(intent);
            return true;
    ...
    public void displayDives(String optimize) {
        ...
        mRuleOfThirdsManageDiveSegment.getDivesForCompare(mDivesForCompare);

        // Generate the DIVE_SEGMENT
        mRuleOfThirdsManageDiveSegment.generateDive(optimize, mDivesForCompare, this);
