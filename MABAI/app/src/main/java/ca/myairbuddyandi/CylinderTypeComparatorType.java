 ...
 * Comparator to sort on CylinderType Type
 */

public class CylinderTypeComparatorType implements Comparator<CylinderType> {

    // Static
    private static final String LOG_TAG = "CylinderTypeComparatorType";
    ...
    // Public constructor
    public CylinderTypeComparatorType(boolean desc) {
        if (desc) mod =-1;
    }
