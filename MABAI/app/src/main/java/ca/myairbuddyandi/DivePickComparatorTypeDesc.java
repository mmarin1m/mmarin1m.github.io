 ...
 * Comparator to sort on DivePick Type Description
 */

public class DivePickComparatorTypeDesc implements Comparator<DivePick> {

    // Static
    private static final String LOG_TAG = "DivePickComparatorTypeDesc";
    ...
    // Public constructor
    DivePickComparatorTypeDesc(boolean desc) {if (desc) mod =-1;}

    public int compare(DivePick c1, DivePick c2) {
        Matcher matcher1 = PATTERN.matcher(c1.getDiveTypeDesc());
        Matcher matcher2 = PATTERN.matcher(c2.getDiveTypeDesc());
