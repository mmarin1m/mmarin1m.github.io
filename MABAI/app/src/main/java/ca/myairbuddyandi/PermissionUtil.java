...
public class PermissionUtil {
     ...
     * Fazal
     *
     * <a href="https://gist.github.com/zeero0/fd314a281d007283fc7931f1c5da634c">...</a>
     *
    ...
    public static boolean checkAndRequestPermissions(Activity activity, String... permissions) {
        ...
        if (!permissionsList.isEmpty()) {
            ActivityCompat.requestPermissions(activity,
                    ...
                    MyConstants.REQ_CODE_PERMISSION_UTIL);
            return false;
        }
    ...
    public static void onRequestPermissionsResult(final Activity activity, int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults, final PermissionsCallBack callBack) {
        if (requestCode == MyConstants.REQ_CODE_PERMISSION_UTIL && grantResults.length > 0) {
    ...
    private static void showAlertDialog(Context context,
        ...
        new AlertDialog.Builder(context)
                .setTitle(R.string.dlg_bluetooth_missing_permission)
                .setMessage(R.string.msg_permission_show_rationale)
                .setPositiveButton(R.string.dlg_positive, okListener)
                .setNegativeButton(R.string.dlg_negative, cancelListener)
                .create()
                .show();
    }
