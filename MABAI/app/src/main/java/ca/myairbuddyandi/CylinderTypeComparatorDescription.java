 ...
 * Comparator to sort on CylinderType Description
 */

public class CylinderTypeComparatorDescription implements Comparator<CylinderType> {

    // Static
    private static final String LOG_TAG = "CylinderTypeComparatorDescription";
    ...
    // Public constructor
    public CylinderTypeComparatorDescription(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(CylinderType c1, CylinderType c2) {
