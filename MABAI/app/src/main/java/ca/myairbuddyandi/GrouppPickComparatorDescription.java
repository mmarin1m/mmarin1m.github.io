 ...
 * Comparator to sort on GrouppPick Description
 */

public class GrouppPickComparatorDescription implements Comparator<GrouppPick> {

    // Static
    private static final String LOG_TAG = "GrouppPickComparatorDescription";
    ...
    // Public constructor
    public GrouppPickComparatorDescription(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(GrouppPick c1, GrouppPick c2) {
