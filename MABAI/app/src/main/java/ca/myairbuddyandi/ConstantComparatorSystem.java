 ...
 * Comparator to sort on Constant System
 */

class ConstantComparatorSystem implements Comparator<Constant> {

    // Static
    private static final String LOG_TAG = "ConstantComparatorSystem";
    ...
    // Public constructor
    public ConstantComparatorSystem(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(Constant c1, Constant c2) {
        Matcher matcher1 = PATTERN.matcher(c1.getSystem());
        Matcher matcher2 = PATTERN.matcher(c2.getSystem());
