...
/**
 * Created by Michel on 2020-12-28.
 * Comparator to sort on DivePick Location
 */

// NOTE: Reserved for future use
public class DivePickComparatorLocation implements Comparator<DivePick> {

    // Static
    private static final String LOG_TAG = "DivePickComparatorLocation";
    ...
    // Public constructor
    public DivePickComparatorLocation(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(DivePick c1, DivePick c2) {
        Matcher matcher1 = PATTERN.matcher(c1.getLocation());
        Matcher matcher2 = PATTERN.matcher(c2.getLocation());
