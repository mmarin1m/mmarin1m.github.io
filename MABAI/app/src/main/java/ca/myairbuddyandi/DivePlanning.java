...
public class DivePlanning extends BaseObservable implements Parcelable {

    // Static
    private static final String LOG_TAG = "Dive";

    // Public
    public DivePlanningBinding mBinding = null;
    ...
    public boolean equals(Object o) {
        ...
        DivePlanning dive = (DivePlanning) o;
    ...
    protected DivePlanning(Parcel in) {
    ...
    public static final Creator<DivePlanning> CREATOR = new Creator<DivePlanning>() {
        @Override
        public DivePlanning createFromParcel(Parcel source) {
            return new DivePlanning(source);
        }

        @Override
        public DivePlanning[] newArray(int size) {
            return new DivePlanning[size];
        }
    };
}
