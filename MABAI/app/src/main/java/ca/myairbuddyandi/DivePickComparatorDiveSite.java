...
public class DivePickComparatorDiveSite implements Comparator<DivePick> {

    // Static
    private static final String LOG_TAG = "DivePickComparatorDiveSite";
    ...
    // Public constructor
    public DivePickComparatorDiveSite(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(DivePick c1, DivePick c2) {
        Matcher matcher1 = PATTERN.matcher(c1.getDiveSite());
        Matcher matcher2 = PATTERN.matcher(c2.getDiveSite());
