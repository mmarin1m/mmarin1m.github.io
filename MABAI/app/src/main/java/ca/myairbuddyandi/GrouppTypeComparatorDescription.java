 ...
 * Comparator to sort on GrouppType Description
 */

public class GrouppTypeComparatorDescription implements Comparator<GrouppType> {

    // Static
    private static final String LOG_TAG = "GrouppTypeComparatorDescription";
    ...
    // Public constructor
    public GrouppTypeComparatorDescription(boolean desc) {if (desc) mod =-1;}

    public int compare(GrouppType c1, GrouppType c2) {
