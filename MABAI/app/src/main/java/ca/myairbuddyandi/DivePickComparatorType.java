 ...
 * Comparator to sort on DivePick Type
 */

// NOTE: Reserved for future use
public class DivePickComparatorType implements Comparator<DivePick> {

    // Static
    private static final String LOG_TAG = "DivePickComparatorType";
    ...
    // Public constructor
    DivePickComparatorType(boolean desc) {
        if (desc) mod =-1;
    }
