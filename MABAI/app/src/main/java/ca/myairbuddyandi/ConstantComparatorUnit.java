 ...
 * Comparator to sort on Constant Unit
 */

public class ConstantComparatorUnit implements Comparator<Constant> {

    // Static
    private static final String LOG_TAG = "ConstantComparatorUnit";
    ...
    // Public constructor
    public ConstantComparatorUnit(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(Constant c1, Constant c2) {
        Matcher matcher1 = PATTERN.matcher(c1.getUnit());
        Matcher matcher2 = PATTERN.matcher(c2.getUnit());
