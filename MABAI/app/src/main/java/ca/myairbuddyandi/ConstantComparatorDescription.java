 ...
 * Comparator to sort on Constant Description
 */

class ConstantComparatorDescription implements Comparator<Constant> {

    // Static
    private static final String LOG_TAG = "ConstantComparatorDescription";
    ...
    // Public constructor
    public ConstantComparatorDescription(boolean desc) {
        if (desc) mod =-1;
    }
