 ...
 * Comparator to sort on DiverDiveGroupCyl Usage Type
 */

// NOTE: Reserved for future use
public class DiverDiveGroupCylPickComparatorUsageType implements Comparator<DiverDiveGroupCyl> {

    // Static
    private static final String LOG_TAG = "DiverDiveGroupCylPickComparatorUsageType";
    ...
    // Public constructor
    public DiverDiveGroupCylPickComparatorUsageType(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(DiverDiveGroupCyl c1, DiverDiveGroupCyl c2) {
        Matcher matcher1 = PATTERN.matcher(c1.getUsageType());
        Matcher matcher2 = PATTERN.matcher(c2.getUsageType());
