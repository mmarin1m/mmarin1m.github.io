 ...
 * Comparator to sort on SegmentType Type
 */

public class SegmentTypeComparatorType implements Comparator<SegmentType> {

    // Static
    private static final String LOG_TAG = "SegmentTypeComparatorType";
    ...
    // Public constructor
    public SegmentTypeComparatorType(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(SegmentType c1, SegmentType c2) {
        Matcher matcher1 = PATTERN.matcher(c1.getSegmentType());
        Matcher matcher2 = PATTERN.matcher(c2.getSegmentType());
