 ...
 * Comparator to sort on UsageType Type
 */

public class UsageTypeComparatorType implements Comparator<UsageType> {

    // Static
    private static final String LOG_TAG = "UsageTypeComparatorType";
    ...
    // Public constructor
    public UsageTypeComparatorType(boolean desc) {
        if (desc) mod =-1;
    }
