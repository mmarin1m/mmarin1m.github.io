 ...
 * Comparator to sort on DiverPick Full Name
 */

public class DiverPickComparatorFullName implements Comparator<Diver> {

    // Static
    private static final String LOG_TAG = "DiverPickComparatorFullName";
    ...
    // Public constructor
    public DiverPickComparatorFullName(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(Diver c1, Diver c2) {
        Matcher matcher1 = PATTERN.matcher(c1.getFullName());
        Matcher matcher2 = PATTERN.matcher(c2.getFullName());
