...
import ca.myairbuddyandi.databinding.DriftCompareActivityBinding;

/**
 * Created by Michel on 2020-12-01.
 * Holds all the logic for the DriftCompareActivity class
 */

public class DriftCompareActivity extends AppCompatActivity {

    // Static
    private static final String LOG_TAG = "DriftCompareActivity";
    ...
    private DriftCompareActivityBinding mBinding = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.drift_compare_activity);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_contact_us) {
            ...
            intent.putExtra(getString(R.string.app_help_topic), getString(R.string.act_compare_drift_dives));
            startActivity(intent);
            return true;
    ...
    public void displayDives(String optimize) {
        ...
        mDriftManageDiveSegment.getDivesForCompare(mDivesForCompare);

        // Generate the DIVE_SEGMENT
        mDriftManageDiveSegment.generateDive(optimize, mDivesForCompare, this);
