 ...
 * Comparator to sort on Acronym Acronym
 */

public class AcronymComparatorAcronym implements Comparator<Acronym> {

    // Static
    private static final String LOG_TAG = "AcronymComparatorAcronym";
    ...
    // Public constructor
    public AcronymComparatorAcronym(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(Acronym c1, Acronym c2) {
        Matcher matcher1 = PATTERN.matcher(c1.getAcronym());
        Matcher matcher2 = PATTERN.matcher(c2.getAcronym());
