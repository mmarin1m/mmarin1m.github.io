 ...
 * Comparator to sort on UsageType Description
 */

public class UsageTypeComparatorDescription implements Comparator<UsageType> {

    // Static
    private static final String LOG_TAG = "UsageTypeComparatorDescription";
    ...
    // Public constructor
    public UsageTypeComparatorDescription(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(UsageType c1, UsageType c2) {
