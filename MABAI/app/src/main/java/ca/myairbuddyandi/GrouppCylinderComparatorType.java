 ...
 * Comparator to sort on GrouppCylinder Type
 */

public class GrouppCylinderComparatorType implements Comparator<GrouppCylinder> {

    // Static
    private static final String LOG_TAG = "GrouppCylinderComparatorType";
    ...
    // Public constructor
    public GrouppCylinderComparatorType(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(GrouppCylinder c1, GrouppCylinder c2) {
