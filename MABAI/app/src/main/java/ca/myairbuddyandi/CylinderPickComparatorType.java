 ...
 * Comparator to sort on CylinderPick Type
 */

public class CylinderPickComparatorType implements Comparator<CylinderPick> {

    // Static
    private static final String LOG_TAG = "CylinderPickComparatorType";
    ...
    // Public constructor
    public CylinderPickComparatorType(boolean desc) {
        if (desc) mod =-1;
    }
