 ...
 * Comparator to sort on SegmentType Description
 */

public class SegmentTypeComparatorDescription implements Comparator<SegmentType> {

    // Static
    private static final String LOG_TAG = "SegmentTypeComparatorDescription";
    ...
    // Public constructor
    public SegmentTypeComparatorDescription(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(SegmentType c1, SegmentType c2) {
