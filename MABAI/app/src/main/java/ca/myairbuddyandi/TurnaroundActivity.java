...
import ca.myairbuddyandi.databinding.TurnaroundActivityBinding;

/**
 * Created by Michel on 2017-01-03.
 * Holds all the logic for the TurnaroundActivity class
 */

public class TurnaroundActivity extends AppCompatActivity {

    // Static
    private static final String LOG_TAG = "TurnaroundActivity";
    ...
    private TurnaroundManageDiveSegment mTurnaroundManageDiveSegment;
    private TurnaroundActivityBinding mBinding = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTurnaroundManageDiveSegment = new TurnaroundManageDiveSegment(this);
        ...
        mTurnaroundManageDiveSegment.getDiveForGraphic(mDivePick.getDiveNo(), mDiveForGraphic);

        mBinding = DataBindingUtil.setContentView(this, R.layout.turnaround_activity);
        ...
        mMyMinPressure = Integer.parseInt(MyFunctions.replaceEmptyByZero(Objects.requireNonNull(preferences.getString(MyConstants.MY_MIN_PRESSURE, mTurnaroundManageDiveSegment.getMyMinPressureDefault()))));
        ...
        mBinding.meLbl.setOnClickListener(view -> {
            ...
            mBinding.turnaroundView.setDiveSegmentDetail(mMyDiverDiveSegmentDetail);
            mBinding.turnaroundView.setDiveSegmentDescent(mMyDiverSegmentDescentList);
            mBinding.turnaroundView.setDiveSegmentAscent(mMyDiverSegmentAscentList);
            enableMyBuddy();
            mBinding.turnaroundView.invalidate();
        });
        ...
        mBinding.myBuddyLbl.setOnClickListener(view -> {
            ...
            mBinding.turnaroundView.setDiveSegmentDetail(mMyBuddyDiveSegmentDetail);
            mBinding.turnaroundView.setDiveSegmentDescent(mMyBuddyDiverSegmentDescentList);
            mBinding.turnaroundView.setDiveSegmentAscent(mMyBuddyDiverSegmentAscentList);
            enableMe();
            mBinding.turnaroundView.invalidate();
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_contact_us) {
            ...
            intent.putExtra(getString(R.string.app_help_topic), getString(R.string.act_turnaround));
            startActivity(intent);
            return true;
    ...
    public void displayView(String optimize) {
        ...
        mTurnaroundManageDiveSegment.generateDive(optimize, mDiveForGraphic);
