 ...
 * Comparator to sort on GrouppType Type
 */

public class GrouppTypeComparatorType implements Comparator<GrouppType> {

    // Static
    private static final String LOG_TAG = "GrouppTypeComparatorType";
    ...
    // Public constructor
    public GrouppTypeComparatorType(boolean desc) {
        if (desc) mod =-1;
    }
