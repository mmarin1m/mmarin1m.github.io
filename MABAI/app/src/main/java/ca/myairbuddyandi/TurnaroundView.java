 ...
 * Holds all of the logic for the TurnaroundView class
 */

public class TurnaroundView extends View {

    // Static
    private static final String LOG_TAG = "TurnaroundView";
    ...
    // Public constructor
    public TurnaroundView(Context context, @Nullable AttributeSet attrs) {
    ...
    // Public constructor
    public TurnaroundView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
