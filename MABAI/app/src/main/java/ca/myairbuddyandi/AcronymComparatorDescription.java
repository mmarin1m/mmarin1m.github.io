...
public class AcronymComparatorDescription implements Comparator<Acronym> {

    // Static
    private static final String LOG_TAG = "AcronymComparatorDescription";
    ...
    // Public constructor
    public AcronymComparatorDescription(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(Acronym c1, Acronym c2) {
