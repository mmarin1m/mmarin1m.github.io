...
import ca.myairbuddyandi.databinding.TurnaroundCompareActivityBinding;

/**
 * Created by Michel on 2020-12-01.
 * Holds all the logic for the TurnaroundCompareActivity class
 */

public class TurnaroundCompareActivity extends AppCompatActivity {
    ...
    private TurnaroundCompareActivityBinding mBinding = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.turnaround_compare_activity);
        ...
        mBinding.minimize.setOnClickListener(view -> {
            ...
            displayDives(MyConstants.MINUS);
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_contact_us) {
            ...
            intent.putExtra(getString(R.string.app_help_topic), getString(R.string.act_compare_turnaround_dives));
            startActivity(intent);
            return true;
    ...
    public void displayDives(String optimize) {
        mAirDa.open();

        // Get the Dive data - First pass, reads the current Dive Info but the previous Dive Segment summary
        mTurnaroundManageDiveSegment.getDivesForCompare(mDivesForCompare);

        // Generate the DIVE_SEGMENT
        mTurnaroundManageDiveSegment.generateDive(optimize, mDivesForCompare, this);
