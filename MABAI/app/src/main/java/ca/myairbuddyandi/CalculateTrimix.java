...
/**
 * Created by Michel on 2020-09-07.
 * Holds all of the logic for the CalculateTrimix class
 */

public class CalculateTrimix extends BaseObservable {

    // Static
    private static final String LOG_TAG = "CalculateTrimix";

    // Public
    public CalculateTrimixActivityBinding mBinding = null;
    ...
    private int mPressureHeliumAdd = MyConstants.ZERO_I;
    private int mPressureHeliumTotal = MyConstants.ZERO_I;
    ...
    private Double mMixHeFill = MyConstants.ZERO_D;
    private Double mMixO2Fill = MyConstants.ZERO_D;
    private Double mMixHeDesired = MyConstants.ZERO_D;
    private Double mMixHeStart = MyConstants.ZERO_D;
    private Double mMixHeHose = MyConstants.ZERO_D;
    ...
    @Bindable
    public String getHeliumAddLbl() {return mHeliumAddLbl; }

    public void setHeliumAddLbl(String heliumAddLbl) {
        mHeliumAddLbl = heliumAddLbl;
        notifyPropertyChanged(BR.heliumAddLbl);
    }

    //

    @Bindable
    public Double getMixHeDesired() {return mMixHeDesired; }

    public void setMixHeDesired(Double mixHeDesired) { mMixHeDesired = mixHeDesired; }

    //

    @Bindable
    public Double getMixHeStart() {return mMixHeStart; }

    public void setMixHeStart(Double mixHeStart) { mMixHeStart = mixHeStart; }
    ...
    // Typically 100.0 for 100% He
    @Bindable
    public Double getMixHeFill() {return mMixHeFill; }

    public void setMixHeFill(Double mixHeFill) { mMixHeFill = mixHeFill; }
    ...
    @Bindable
    public Double getMixHeHose() {return mMixHeHose; }

    public void setMixHeHose(Double mixHeHose) { mMixHeHose = mixHeHose; }
    ...
    @Bindable
    public int getPressureHeliumAdd() {return mPressureHeliumAdd; }

    public void setPressureHeliumAdd(int pressureHeliumAdd) {
        mPressureHeliumAdd = pressureHeliumAdd;
        notifyPropertyChanged(BR.pressureHeliumAdd);
    }
    ...
    // NOTE: Reserved for future use
    @Bindable
    public int getPressureHeliumTotal() {return mPressureHeliumTotal; }

    @Bindable
    public String getPressureHeliumTotalS() {return "(" + mPressureHeliumTotal + ")"; }

    public void setPressureHeliumTotal(int pressureHeliumTotal) {
        mPressureHeliumTotal = pressureHeliumTotal;
        notifyPropertyChanged(BR.pressureHeliumTotalS);
    }
