 ...
 * Holds all of the logic for the RuleOfThirdsView class
 */

public class RuleOfThirdsView extends View {

    // Static
    private static final String LOG_TAG = "RuleOfThirdsView";
    // Public
    ...
    // Public constructor
    public RuleOfThirdsView(Context context) {
        super(context);
        mContext = context;
        setupPaint();
    ...
    // Public constructor
    public RuleOfThirdsView(Context context, @Nullable AttributeSet attrs) {
    ...
    // Public constructor
    public RuleOfThirdsView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //  3 AS  Ascend to second deepest Bottom Time. If present
        //  4 BT  Second deepest Bottom Time. If present
        //  5 AS  Ascend to third deepest Bottom Time. If present
        //  6 BT  Third deepest Bottom Time. If present
        //  ...
        //  7 ADS Ascend to Deep Stop. If present
        //  8 DS  Deep Stop. If present
        //  9 ASS Ascent toSafety Stop. If present
        // 10 SS  Ascent to Safety Stop. If present
        // 11 AS  Ascent to Surface
