 ...
 * Comparator to sort on DiverDiveGroupCyl Cylinder Type
 */

// NOTE: Reserved for future use
public class DiverDiveGroupCylPickComparatorCylinderType implements Comparator<DiverDiveGroupCyl> {

    // Static
    private static final String LOG_TAG = "DiverDiveGroupCylPickComparatorCylinderType";
    ...
    // Public constructor
    public DiverDiveGroupCylPickComparatorCylinderType(boolean desc) {
        if (desc) mod =-1;
    }

    public int compare(DiverDiveGroupCyl c1, DiverDiveGroupCyl c2) {
        Matcher matcher1 = PATTERN.matcher(c1.getCylinderType());
        Matcher matcher2 = PATTERN.matcher(c2.getCylinderType());
