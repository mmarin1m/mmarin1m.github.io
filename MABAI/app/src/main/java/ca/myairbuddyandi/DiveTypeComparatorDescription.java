 ...
 * Comparator to sort on DiveType Description
 */

public class DiveTypeComparatorDescription implements Comparator<DiveType> {

    // Static
    private static final String LOG_TAG = "DiveTypeComparatorDescription";
    ...
    // Public constructor
    public DiveTypeComparatorDescription(boolean desc) {
        if (desc) mod =-1;
    }
